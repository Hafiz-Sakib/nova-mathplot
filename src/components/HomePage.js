...
const MATH_WORLDS = [
  {
    ...
    symbol: "∫",
    color: "#22d3ee",
    desc: "Derivatives, integrals, limits, and the fundamental theorem of calculus",
    formula: "∫f(x)dx",
  },
  {
    ...
    symbol: "ℂ",
    color: "#f472b6",
    desc: "Numbers in the imaginary plane, Euler's formula in complex",
    formula: "e^(iπ)+1=0",
  },
  {
    name: "Topology",
    symbol: "∞",
    color: "#a78bfa",
    desc: "Shapes, surfaces, knots, and properties preserved under continuous deformation",
    formula: "χ=2-2g",
  },
  {
  ...
  },
  {
    ...
    symbol: "M",
    color: "#10b981",
    desc: "Vectors, matrices, eigenvalues, and transformations in space",
    formula: "Av=λv",
  },
  {
