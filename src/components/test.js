      ...
      <section className="px-4 sm:px-8 pb-24 max-w-5xl mx-auto">
        ...
        <RevealSection>
          <SectionHeader
            ...
            isDark={isDark}
            subtitle="See how NOVA MathPlot stacks up against other math visualization tools."
            color="#fbbf24"
          />
          <div
          ...
          >
            ...
            >
              ...
              {[
                ["NOVA MathPlot", "#22d3ee"],
                ["Wolfram Alpha", "#f97316"],
                ["GeoGebra", "#10b981"],
              ].map(([name, col]) => (
                <div
                  key={name}
                  className="text-center font-orbitron font-bold text-xs"
                  style={{ color: col }}
                >
                  {name}
                </div>
            ...
            {COMPARISON_FEATURES.map((row, i) => (
              <div
                key={row.feature}
                className="grid grid-cols-4 px-5 py-3.5 transition-colors"
                style={{
                  background:
                    i % 2 === 0
                      ? isDark
              ...
              >
                ...
                {[row.nova, row.wolfram, row.geogebra].map((val, j) => (
      ...
      <section className="px-4 sm:px-8 pb-24 max-w-7xl mx-auto">
        ...
        <RevealSection>
          <SectionHeader
            ...
            isDark={isDark}
            subtitle="The mind and passion behind NOVA MathPlot."
            color="#a78bfa"
          />
            ...
            <TiltCard intensity={4}>
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg,transparent,#a78bfa80,transparent)",
                  }}
                />
                {/* Bg decoration */}
                <div
                ...
                <div className="flex flex-col sm:flex-row gap-7 items-start relative">
                  <div className="flex-shrink-0 text-center">
                    <div
                      className="w-20 h-20 rounded-2xl flex items-center justify-center text-3xl mb-3"
                      style={{
                        background:
                          "linear-gradient(135deg,rgba(139,92,246,0.2),rgba(244,114,182,0.2))",
                  ...
                  <div className="flex-1">
                    ...
                    <p
                      ...
                      style={{ color: textMuted }}
                    >
                      Software Developer · Mathematician · Visualizer
                    </p>
                    <p
                      className="font-rajdhani text-base leading-relaxed mb-5"
                      style={{ color: textSecondary }}
                    >
                      A passionate software developer and mathematician who
                      built NOVA MathPlot as a creative intersection of
                      mathematics, machine learning visualization, and modern
                      web development. Driven by the belief that beautiful
                      interfaces make complex mathematics accessible to
                      everyone.
                    </p>
